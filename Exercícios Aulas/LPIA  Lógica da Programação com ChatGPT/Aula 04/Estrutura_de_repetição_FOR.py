...
#     numeros = int(input('Digite 10 números e verifique se são positivos ou negativos: '))
...
# Atividade 8.
# Escreva um programa que solicite 5 notas de alunos.
# Use um laço for para somar as notas e uma condicional para exibir a média e a
...
# Atividade 9.
# 1-) Crie um programa que use um laço for para contar de 1 a 20.
# 2-) Use condicionais para identificar números pares e ímpares. 
# 3-) Pare o loop ao encontrar o número 15, usando break.
...
# Atividade 10.
# 1-) Peça ao usuário para inserir 10 números. 
# 2-) Use um laço for com condicionais para contar quantos
#     são positivos e quantos são negativos. 
# 3-) Pare o loop se o número 0 for inserido, usando break.
...
# Atividade 11.
# 1-) Escreva um programa que use um laço for para imprimir números de 1 a 30.
# 2-) Use uma condicional para verificar se um número é múltiplo de 5 e outro
...
# Atividade 12.
# 1-) Peça ao usuário para inserir 5 preços de produtos. Use um laço for para
#     calcular o total. 
# 2-) Aplique um desconto de 10% se o total ultrapassar 100 e

# Defina estruturas de dados para representar tarefas. Cada tarefa pode incluir informações como nome, descrição, prioridade e categoria. Você pode usar dicionários para representar as tarefas. Crie funções para adicionar tarefas, listar tarefas, marcar tarefas como concluídas, exibir tarefas por prioridade ou categoria, e outras funcionalidades que desejar.Crie um menu de comandos de linha de comando que permita ao usuário interagir com o programa.
...
while True:
    ...
    if escolha == '1':
        ...
        ver_tarefas(tarefas)
        indice_tarefa = int(input('Insira o número da tarefa que você quer atualizar: '))
        atualizar_nome = input('Insira o novo nome da tarefa: ')
        atualizar_tarefas(tarefas, indice_tarefa, atualizar_nome)

    elif escolha == '4':
        ver_tarefas(tarefas)
        indice_tarefa = int(input('Insira o número da tarefa que você completou: '))

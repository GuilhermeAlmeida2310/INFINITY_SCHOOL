...
# Cada classe deve ter um método chamado falar (),
# que imprime uma mensagem específica na tela:
...
# - No final, crie um objeto para cada uma das classes e chame o
# método falar () de cada objeto.

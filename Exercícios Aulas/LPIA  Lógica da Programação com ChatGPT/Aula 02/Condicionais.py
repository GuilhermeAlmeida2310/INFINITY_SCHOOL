...
# print(f'Seu desconto é de {desconto}, seu preço com desconto é de R${preco_com_desconto} ')
...
# Atividade 13.
# 1-) Desenvolva um programa que peça ao usuário um nome de usuário
# e uma senha 
# 2-) e use if para verificar se são iguais a "admin" e "1234",
# respectivamente.
...
# Atividade 14.
# 1-) Crie um programa que peça ao usuário o preço original de um produto e
#     a quantidade comprada. 
# 2-) Use if para verificar se a quantidade é maior que
